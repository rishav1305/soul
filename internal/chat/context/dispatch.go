...
func NewDispatcher() *Dispatcher {
	d := &Dispatcher{
		...
		routes: map[string]ToolRoute{
			...
			// Batch 2 tools
			"sow_generator":              {Method: "POST", Path: "/api/ai/sow", Product: "scout", Timeout: 30 * time.Second},
			"contract_followup":          {Method: "POST", Path: "/api/ai/contract-followup", Product: "scout", Timeout: 30 * time.Second},
			"case_study_draft":           {Method: "POST", Path: "/api/ai/case-study", Product: "scout", Timeout: 30 * time.Second},
			"consulting_followup":        {Method: "POST", Path: "/api/ai/consulting-followup", Product: "scout", Timeout: 30 * time.Second},
			"advisory_proposal":          {Method: "POST", Path: "/api/ai/advisory-proposal", Product: "scout", Timeout: 30 * time.Second},
			"project_proposal":           {Method: "POST", Path: "/api/ai/project-proposal", Product: "scout", Timeout: 30 * time.Second},
			"consulting_upsell_evaluator": {Method: "POST", Path: "/api/ai/consulting-upsell", Product: "scout", Timeout: 30 * time.Second},
			"thread_converter":           {Method: "POST", Path: "/api/ai/thread-converter", Product: "scout", Timeout: 30 * time.Second},
			"substack_expander":          {Method: "POST", Path: "/api/ai/substack-expander", Product: "scout", Timeout: 30 * time.Second},
			"reactive_content_gen":       {Method: "POST", Path: "/api/ai/reactive-content", Product: "scout", Timeout: 30 * time.Second},
			"engagement_reply":           {Method: "POST", Path: "/api/ai/engagement-reply", Product: "scout", Timeout: 30 * time.Second},
			"content_metrics":            {Method: "POST", Path: "/api/ai/content-metrics", Product: "scout", Timeout: 30 * time.Second},
			"linkedin_update":            {Method: "POST", Path: "/api/ai/linkedin-update", Product: "scout", Timeout: 30 * time.Second},
			"github_readme_gen":          {Method: "POST", Path: "/api/ai/github-readme", Product: "scout", Timeout: 30 * time.Second},
			"profile_audit":              {Method: "POST", Path: "/api/ai/profile-audit", Product: "scout", Timeout: 30 * time.Second},
			"testimonial_request":        {Method: "POST", Path: "/api/ai/testimonial-request", Product: "scout", Timeout: 30 * time.Second},
			"pin_recommendation":         {Method: "POST", Path: "/api/ai/pin-recommendation", Product: "scout", Timeout: 30 * time.Second},
			"contract_upsell_detector":   {Method: "POST", Path: "/api/ai/contract-upsell", Product: "scout", Timeout: 30 * time.Second},
		},
	}
	return d
}
