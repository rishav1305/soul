...
import type { PlannerTask, TaskStage, TaskView, GridSubView, TaskFilters, PlannerActivity, TaskComment } from '../../lib/types.ts';
        ...
        {isNarrow ? (
          <div className="relative" ref={filterPopoverRef}>
            <button
              ...
              data-testid="filter-popover-toggle"
