...
import type { PlannerTask, TaskStage, PlannerActivity, TaskComment, ProductInfo } from '../../lib/types.ts';
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 h-[34px]">
                      <button
                        ...
                        data-testid="task-detail-autonomous"
              ...
              <div className="pt-3 border-t border-border-subtle">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    data-testid="task-detail-submit-comment"
