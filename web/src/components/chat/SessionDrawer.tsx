...
function statusDot(status: ChatSession['status']) {
  switch (status) {
    ...
    case 'completed_unread':
      return <span className="w-1.5 h-1.5 rounded-full bg-stage-done shrink-0 ring-1 ring-stage-done/30" />;
    case 'idle':
      return <span className="w-1.5 h-1.5 rounded-full bg-fg-muted/40 shrink-0" />;
    case 'completed':
      return <span className="w-1.5 h-1.5 rounded-full bg-fg-muted/20 shrink-0" />;
  }
}
...
export default function SessionDrawer({
  ...
  return (
    <>
      ...
      {/* Full-width overlay */}
      <div className="absolute inset-0 z-20 bg-surface flex flex-col" data-testid="session-drawer">
        {/* Header */}
        ...
        <div className="px-3 py-2 border-b border-border-subtle shrink-0">
          <div className="relative">
            ...
            <input
              ...
              data-testid="session-drawer-search"
            />
          </div>
        </div>
